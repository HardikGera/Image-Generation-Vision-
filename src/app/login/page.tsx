...
export default function LoginPage() {
  ...
  // Server-side redirect happens in middleware if user is already logged in
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Add explicit redirect to home page
      router.push('/');
    } catch (err: any) {
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center py-2 px-4 border border-gray-700 rounded-md 
                           shadow-sm bg-gray-700 text-sm font-medium text-white hover:bg-gray-600 focus:outline-none 
